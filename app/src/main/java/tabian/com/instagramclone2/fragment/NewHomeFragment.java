...
public class NewHomeFragment extends Fragment  implements OnUpdateListener, OnLoadListener {
            ...
            query.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    for ( DataSnapshot singleSnapshot :  dataSnapshot.getChildren()){
                        ...
                        newPhoto.setKategori(objectMap.get(getString(R.string.field_kategori)).toString());
                        newPhoto.setAddress(objectMap.get(getString(R.string.field_address)).toString());
...
//
                ...
                adapter = new MainfeedListAdapter(getActivity(), R.layout.layout_view_post, mPaginatedPhotos);
                mListView.setAdapter(adapter);
